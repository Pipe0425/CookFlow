...
```
java -Dspring.profiles.active=production -jar ./target/CookFlow-Gestion-de-tareas-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify.cookflow/cook-flow-gestion-de-tareas
```
